...
export default function ContentEdit(params: {nota: TPlainNota}) {
    ...
    return (
            <div style={{height: "100%", width: "100%"}} contenteditable={true} class="contenuto" innerHTML={htmlContenuto()}></div>
    )
}